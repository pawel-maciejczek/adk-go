...
type Telemetry interface {
	// SetGlobalProviders installs global otel providers.
	SetGlobalProviders()
...
// NewWithOptions initializes new telemetry.
...
func NewWithOptions(ctx context.Context, opts ...Option) (Telemetry, error) {
